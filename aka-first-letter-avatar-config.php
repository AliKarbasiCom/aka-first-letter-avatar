...
class WP_First_Letter_Avatar_Config {
	...
	public function settings_init(){
		...
		register_setting('wpfla_pluginPage', 'wpfla_settings');
		 ...
		 add_settings_section(
			...
			__('Plugin configuration', 'aka-first-letter-avatar'),
		...
		add_settings_field(
			'wpfla_letter_index',
			__('Letter index', 'aka-first-letter-avatar') . '<br/>' . __('Default:', 'aka-first-letter-avatar') . ' 0',
		...
		add_settings_field(
			'wpfla_file_format',
			__('File format', 'aka-first-letter-avatar') . '<br/>' . __('Default:', 'aka-first-letter-avatar') . ' png',
		...
		add_settings_field(
			'wpfla_unknown_image',
			__('Unknown image name', 'aka-first-letter-avatar') . '<br/>' . __('Default:', 'aka-first-letter-avatar') . ' mystery',
		...
		add_settings_field(
			'wpfla_avatar_set',
			__('Avatar set', 'aka-first-letter-avatar') . '<br/>' . __('Default:', 'aka-first-letter-avatar') . ' default',
		...
		add_settings_field(
			'wpfla_use_gravatar',
			__('Use Gravatar', 'aka-first-letter-avatar') . '<br/>' . __('Default:', 'aka-first-letter-avatar') . ' ' .  __('check', 'aka-first-letter-avatar'),
		...
		add_settings_field(
			'wpfla_round_avatars',
			__('Round avatars', 'aka-first-letter-avatar') . '<br/>' . __('Default:', 'aka-first-letter-avatar') . ' ' .  __('uncheck', 'aka-first-letter-avatar'),
		...
		add_settings_field(
			...
			__('Plugin filter priority', 'aka-first-letter-avatar') . '<br/>' . __('Default:', 'aka-first-letter-avatar') . ' 10',
	...
	public function options_page(){
		...
		<form action='options.php' method='post'>
			...
			<h3><?php _e('Fields description:', 'aka-first-letter-avatar'); ?></h3>
			<p>
				<strong><?php _e('Letter index', 'aka-first-letter-avatar'); ?></strong><br />
				<?php echo sprintf(__('%s use first letter for the avatar; %s use second letter; %s use last letter, etc.', 'aka-first-letter-avatar'),
			...
			<p>
				<strong><?php _e('File format', 'aka-first-letter-avatar'); ?></strong><br />
				<?php echo sprintf(__('File format of your avatars, for example %s or %s.', 'aka-first-letter-avatar'),
				'<span style="text-decoration: underline">png</span>', '<span style="text-decoration: underline">jpg</span>'); ?>
			</p>
			<p>
				<strong><?php _e('Unknown image name', 'aka-first-letter-avatar'); ?></strong><br />
				<?php _e('Name of the file used for unknown usernames (without extension).', 'aka-first-letter-avatar'); ?>
			</p>
			<p>
				<strong><?php _e('Avatar set', 'aka-first-letter-avatar'); ?></strong><br />
				<?php _e('Directory where your avatars are stored. Supplied sets: "default", "opensans" and "roboto".', 'aka-first-letter-avatar'); ?>
			</p>
			<p>
				<strong><?php _e('Use Gravatar', 'aka-first-letter-avatar'); ?></strong><br />
				<?php echo sprintf(__('%sCheck%s: use Gravatar when available; %sUncheck%s: always use custom avatars.', 'aka-first-letter-avatar'),
				'<span style="text-decoration: underline">', '</span>', '<span style="text-decoration: underline">', '</span>'); ?>
			</p>
			<p>
				<strong><?php _e('Round avatars', 'aka-first-letter-avatar'); ?></strong><br />
				<?php echo sprintf(__('%sCheck%s: use rounded avatars; %sUncheck%s: use standard avatars. This may not always work - your theme may override this setting.', 'aka-first-letter-avatar'),
				'<span style="text-decoration: underline">', '</span>', '<span style="text-decoration: underline">', '</span>'); ?>
			</p>
			<p>
				<strong><?php _e('Filter priority', 'aka-first-letter-avatar'); ?></strong><br />
				<?php _e('If you are using multiple avatar plugins, you can increase or decrease execution priority of this plugin. If WP First Letter Avatar is overriding your other plugins, try changing this to a lower value (for example 9).', 'aka-first-letter-avatar'); ?>
			</p>
			<p><?php _e('In case of any problems, please use default values.', 'aka-first-letter-avatar'); ?></p>
